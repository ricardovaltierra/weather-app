...
/*!******************************!*\
  !*** ./src/credentials.json ***!
  \******************************/
/*! exports provided: id, key, default */
/***/ (function(module) {

eval("module.exports = JSON.parse(\"{\\\"id\\\":\\\"r4uLOGuQM6xujO7Lp2oc4\\\",\\\"key\\\":\\\"JPXytxCo4GIR9eLKviQqPNcZ5QWP3fmeQtuQjvRR\\\"}\");\n\n//# sourceURL=webpack:///./src/credentials.json?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"render\", function() { return render; });\n/* harmony import */ var _credentials__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./credentials */ \"./src/credentials.json\");\nvar _credentials__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./credentials */ \"./src/credentials.json\", 1);\n/* harmony import */ var _elementsHander__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elementsHander */ \"./src/elementsHander.js\");\n\n\n\n\nasync function getWeather() {\n  try {\n    const response = await fetch(\n      `https://api.aerisapi.com/observations/` + \n      `guanajuato,mx?` + \n      `&format=json&filter=allstations&limit=1` + \n      `&fields=id,ob.dateTimeISO,ob.tempF,ob.tempC,ob.humidity,ob.windSpeedMPH,ob.windSpeedKPH,ob.windDir,ob.weather,ob.feelslikeF,ob.feelslikeC` + \n      `&client_id=${_credentials__WEBPACK_IMPORTED_MODULE_0__[\"id\"]}` + \n      `&client_secret=${_credentials__WEBPACK_IMPORTED_MODULE_0__[\"key\"]}`, \n      {mode: 'cors'}\n    );\n    const weatherData = await response.json();\n  \n    return weatherData;\n  } catch (err) {\n    alert(err);\n  }\n}\n\nfunction setCard() {\n  let container = Object(_elementsHander__WEBPACK_IMPORTED_MODULE_1__[\"createElement\"])('div', 'main', 'card', '');\n\n\n  getWeather().then((weatherData) => {\n    const data = weatherData.response.ob;\n    let dateTimeISO,\n        weather,\n        tempC,\n        tempF,\n        feelslikeC,\n        feelslikeF,\n        windSpeedKPH,\n        windSpeedMPH,\n        humidity,\n        windDir;\n\n    Object(_elementsHander__WEBPACK_IMPORTED_MODULE_1__[\"setInner\"])(container, `Your weather:\n                         <br> Date: ${data.dateTimeISO}\n                         <br> Weather: ${data.weather}\n                         <br> Temp °C: ${data.tempC}\n                         <br> Temp °F: ${data.tempF}\n                         <br> Real feel °C: ${data.feelslikeC}\n                         <br> Real feel °C: ${data.feelslikeF}\n                         <br> Wind speed K/h: ${data.windSpeedKPH}\n                         <br> Wind speed M/h: ${data.windSpeedMPH}\n                         <br> Humidity: ${data.humidity}\n                         <br> Wind direction: ${data.windDir}`);\n\n    console.log(data);\n  });\n  \n\n  return container;\n}\n\nfunction render() {\n  \n  Object(_elementsHander__WEBPACK_IMPORTED_MODULE_1__[\"appendChild\"])(document.body, setCard());\n}\n\n//# sourceURL=webpack:///./src/domHandler.js?");
