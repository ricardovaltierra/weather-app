  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        ...
        'og:image': { property: 'og:image', content: 'https://github.com/ricardovaltierra/weather-app/blob/master/src/img/preview.png' },
        'linkedin:image': { name: 'linkedin:image', content: 'https://github.com/ricardovaltierra/weather-app/blob/master/src/img/preview.png' },
